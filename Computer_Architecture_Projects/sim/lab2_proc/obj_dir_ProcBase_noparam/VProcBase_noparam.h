...
#ifndef VERILATED_VPROCBASE_NOPARAM_H_
#define VERILATED_VPROCBASE_NOPARAM_H_  // guard

#include "verilated.h"
#include "svdpi.h"

class VProcBase_noparam__Syms;
class VProcBase_noparam___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VProcBase_noparam VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VProcBase_noparam___024root* const rootp;
    ...
    explicit VProcBase_noparam(VerilatedContext* contextp, const char* name = "TOP");
    explicit VProcBase_noparam(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VProcBase_noparam();
  private:
    VL_UNCOPYABLE(VProcBase_noparam);  ///< Copying not allowed
